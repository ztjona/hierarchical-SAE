...
**Forward references:** the QC architecture (2026-05-11) extends this
contract with a wider `fc1`, an auxiliary legality head, and a no-mask
companion bot — same 32-d aux, same `unified_autoreg` schema. See
[`docs/diary/2026-05-11_qc-no-mask.md`](2026-05-11_qc-no-mask.md).
