...
EXPERIMENT_NAME = "N_LAST_STATES_FINAL_1215-4_10"
...
N_LAST_STATES_FINAL = 10

MATCHES_PER_EPOCH = 64  # number self-play matches per epoch
...
if GEN_EXPERIENCE_BY_EPOCH:
    ...
    REPLAY_SIZE = 500 * STEPS_PER_EPOCH
else:
