...
STARTING_NET = None
EXPERIMENT_NAME = "MF_dataScale(4)0429_MATCHES_320_N_6"
...
# Reduced epochs to compensate for 4× more matches per epoch
EPOCHS = 1_000

N_LAST_STATES_INIT = 6
N_LAST_STATES_FINAL = N_LAST_STATES_INIT  # Fixed N, no curriculum

# 10× the MB baseline (32 → 320) at N=6: tests variance-limited MC estimation
# variance-limited estimation (more data should narrow the γ^k·outcome MC bands).
MATCHES_PER_EPOCH = 320
NUM_EPOCHs_BUFFER = 8

ENDGAME_FRACTION = 0  # no endgame anchoring in this sweep
