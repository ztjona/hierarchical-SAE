...
STARTING_NET = None
EXPERIMENT_NAME = "Ta_minimaxSelect(3)0515_SCALAR"
...
# Ta(3) variant (= Tc): scalar-at-chosen-piece target instead of full 16-d
# vector. Diagnostic — isolates "oracle replaces MC noise" from "oracle
# gives 16× more signal per state". Same depth as Ta(1) so the only
# difference vs Ta(1) is the supervised signal density per SELECT row.
USE_MINIMAX_SELECT_TARGET = True
MINIMAX_SELECT_DEPTH = 2
MINIMAX_SELECT_SCALAR_TARGET = True  # Tc: scalar-at-chosen-piece (4-tuple shape)
