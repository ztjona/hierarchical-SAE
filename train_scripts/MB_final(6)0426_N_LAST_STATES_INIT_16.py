...
EXPERIMENT_NAME = "MB_final(6)0426_N_LAST_STATES_INIT_16"
...
FREQ_EPOCH_SAVING = 50  # save model, figures every n epochs
CHECKPOINT_FREQ = 500  # save model weights every n epochs; final epoch is always saved
...
FREQ_EPOCH_PLOT_SHOW = 1_000_000  # efectivelty disable
